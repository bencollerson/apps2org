...
//				requeryCursor();
        ...
        //TODO getWindow().setFeatureDrawableAlpha(0, 220);
        // R.attr.backgroundDimEnabled
        getWindow().clearFlags(WindowManager.LayoutParams.FLAG_DIM_BEHI‌​ND);
    ...
    private void createAdapter(Cursor cursor) {
        ...
        //final int iconSize = (int) (70 * density);	//72
        //final int width = (int) (96 * density);
        //final int height = (int) (86 * density);
        //
        //final int iconSize = (int) (64 * density);
        //final int width = (int) (90 * density);
        //final int height = (int) (80 * density);
        //
        //final int iconSize = (int) (64 * density);
        //final int width = (int) (96 * density);
        //final int height = (int) (84 * density);    //80
        //
        //final int iconSize = (int) (64 * density);
        //final int width = (int) (96 * density);
        //final int height = (int) (84 * density);
        //
        final int iconSize = (int) (56 * density);
        final int width = (int) (94 * density);
        final int height = (int) (84 * density);

        final AbsListView.LayoutParams layoutParams = new AbsListView.LayoutParams(width, height);
        cursorAdapter = new SimpleCursorAdapter(this, 0, cursor, new String[] { LabelDao.ID_COL_NAME }, new int[] { R.id.name }, 0) {
            @Override
            public View newView(Context context, Cursor cursor, ViewGroup parent) {
                ...
                ////t.setBackground(new ColorDrawable(Color.BLACK));
...
//                        b = new BitmapDrawable(getResources(), BitmapFactory.decodeByteArray(imageBytes, 0, imageBytes.length));
//                    } else {
//                        if (!cursor.isNull(2)) {
