...
public class DbImportExport {
    ...
    public static void export(Activity context, Uri uri) throws IOException {
        DatabaseHelper dbHelper = DatabaseHelper.initOrSingleton(context);

        ParcelFileDescriptor pfd = context.getContentResolver().openFileDescriptor(uri, "w");
        FileOutputStream fileOutputStream = new FileOutputStream(pfd.getFileDescriptor());
        BufferedWriter bout = new BufferedWriter(new OutputStreamWriter(fileOutputStream));
        export(dbHelper, bout);
    }

    private static void export(DatabaseHelper dbHelper, BufferedWriter bout) throws IOException {
        try {
    ...
    public static void importData(Activity context, Uri uri) throws IOException {
        DatabaseHelper dbHelper = DatabaseHelper.initOrSingleton(context);
